...
# the board for the snake game
HEIGHT = 10
WIDTH = 20
FIELD_SIZE = HEIGHT * WIDTH

# snake is always in the first element of snake array
HEAD = 0
...
# four direction for the snake head
LEFT = -1
RIGHT = 1
UP = -WIDTH
DOWN = WIDTH
...
# implement one-dimension array to demonstrate two-dimension array
# board is the play ground
# initial position 
# initial length
board = [0] * FIELD_SIZE
...
while key != 27:
    ...
    # If the snake could eat the food，board_refresh return true
